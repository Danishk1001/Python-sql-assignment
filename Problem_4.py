...
# creating engine
engine = create_engine("postgresql+psycopg2://postgres:Danish01#@localhost:5432/assignment")
...
writer = pd.ExcelWriter('/Users/danish01/Downloads/Problem_4_excel.xlsx')
